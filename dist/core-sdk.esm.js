...
var _SUSHI_ADDRESS, _USDC_ADDRESS, _USD_ADDRESS, _WETH9_ADDRESS, _WNATIVE_ADDRESS, _DAI_ADDRESS, _USDT_ADDRESS, _FACTORY_ADDRESS, _ROUTER_ADDRESS, _BAR_ADDRESS, _BENTOBOX_ADDRESS, _MINICHEF_ADDRESS, _MULTICALL2_ADDRESS;
var SUSHI_ADDRESS = (_SUSHI_ADDRESS = {}, _SUSHI_ADDRESS[ChainId.MOONBEAM] = '0xEb813611a8B5E2f8559F1A156c20904426de1147', _SUSHI_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0x9f6e0E615585a8248dE15362393565415E71DE3D', _SUSHI_ADDRESS);
var USDC_ADDRESS = (_USDC_ADDRESS = {}, _USDC_ADDRESS[ChainId.MOONBEAM] = '0x818ec0A7Fe18Ff94269904fCED6AE3DaE6d6dC0b', _USDC_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0xC53ca2e8A0d26bd498D38064e40bB7F712180a9B', _USDC_ADDRESS);
var USD_ADDRESS = (_USD_ADDRESS = {}, _USD_ADDRESS[ChainId.MOONBEAM] = USDC_ADDRESS[ChainId.MOONBEAM], _USD_ADDRESS[ChainId.MOONBEAM_TESTNET] = USDC_ADDRESS[ChainId.MOONBEAM_TESTNET], _USD_ADDRESS);
var WETH9_ADDRESS = (_WETH9_ADDRESS = {}, _WETH9_ADDRESS[ChainId.MOONBEAM] = '0xAcc15dC74880C9944775448304B263D191c6077F', _WETH9_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0xA5fd1F6e7980Fd5cA9d062a762030D449990BBBf', _WETH9_ADDRESS);
var WNATIVE_ADDRESS = (_WNATIVE_ADDRESS = {}, _WNATIVE_ADDRESS[ChainId.MOONBEAM_TESTNET] = WETH9_ADDRESS[ChainId.MOONBEAM_TESTNET], _WNATIVE_ADDRESS[ChainId.MOONBEAM] = '0xAcc15dC74880C9944775448304B263D191c6077F', _WNATIVE_ADDRESS);
var DAI_ADDRESS = (_DAI_ADDRESS = {}, _DAI_ADDRESS[ChainId.MOONBEAM] = '0x765277EebeCA2e31912C9946eAe1021199B39C61', _DAI_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0xE55f16d23Cc8B1813ae44093a555AFa498bb8dfe', _DAI_ADDRESS);
var USDT_ADDRESS = (_USDT_ADDRESS = {}, _USDT_ADDRESS[ChainId.MOONBEAM] = '0xeFAeeE334F0Fd1712f9a8cc375f427D9Cdd40d73', _USDT_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0x05Bf07102EfEbb83Ba5F475fB18F843E8736B6E8', _USDT_ADDRESS);
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0xF6899c78240F9055F6a896D63Df4dBfbbAa4eace', _FACTORY_ADDRESS[ChainId.MOONBEAM] = '0x7c7EaEa389d958BB37a3fd08706Ca884D53Dc1F3', _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0x46ab221AC1e51968F4C05E57137011c27696d137', _ROUTER_ADDRESS[ChainId.MOONBEAM] = '0xb77EF0475910d1B25FB9e66E3021be63270071C5', _ROUTER_ADDRESS);
var BAR_ADDRESS = (_BAR_ADDRESS = {}, _BAR_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0xBA571227fEA63965bFab3bDb3f4cA45f6882E57e', _BAR_ADDRESS[ChainId.MOONBEAM] = '0xc01EA20752b35f2105D07eE3eed580a117cAABD4', _BAR_ADDRESS);
var MAKER_ADDRESS = {// [ChainId.MOONBEAM_TESTNET]: '0x61DfFD673B37F80AD6707a0C6EB39b57bf5dC97B',
};
var TIMELOCK_ADDRESS = {// [ChainId.MOONBEAM_TESTNET]: '0x1B3BeC53e38506015ca136a725C3bbd185E1333E',
};
var BENTOBOX_ADDRESS = (_BENTOBOX_ADDRESS = {}, _BENTOBOX_ADDRESS[ChainId.MOONBEAM] = '0x80C7DD17B01855a6D2347444a0FCC36136a314de', _BENTOBOX_ADDRESS);
var MINICHEF_ADDRESS = (_MINICHEF_ADDRESS = {}, _MINICHEF_ADDRESS[ChainId.MOONBEAM] = '0x1Dd9D4f939e975414Ce15F1783ca39164d13C523', _MINICHEF_ADDRESS[ChainId.MOONBEAM_TESTNET] = '0x9E7E919AaA39eb92280fd539b093EE67d365e4e6', _MINICHEF_ADDRESS);
var MULTICALL2_ADDRESS = (_MULTICALL2_ADDRESS = {}, _MULTICALL2_ADDRESS[ChainId.MOONBEAM] = '0x3B3f8c287181EF3F03ef3318Cf40063652f58679', _MULTICALL2_ADDRESS[ChainId.MOONBEAM_TESTNET] = "0xD91EB014D129f6fd903c1C3c02E2637d1f87584B", _MULTICALL2_ADDRESS);

var _CHAIN_KEY;
var CHAIN_KEY = (_CHAIN_KEY = {}, _CHAIN_KEY[ChainId.MOONBEAM_TESTNET] = ChainKey.MOONBEAM_TESTNET, _CHAIN_KEY[ChainId.MOONBEAM] = ChainKey.MOONBEAM, _CHAIN_KEY);

var _INIT_CODE_HASH;
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MOONBEAM_TESTNET] = '0x63b34ef62996dbb5d4710d546f9b2612c77544b2dc001ebecd5287378d17a904', _INIT_CODE_HASH[ChainId.MOONBEAM] = '0x75fd3fc472ee1f8f5b540db733acc7e6fae937af57ce0ae705ad2ec072759acd', _INIT_CODE_HASH);
...
var _USDC, _WETH, _WNATIVE, _SUSHI;
var USDC = (_USDC = {}, _USDC[ChainId.MOONBEAM] = /*#__PURE__*/new Token(ChainId.MOONBEAM, USDC_ADDRESS[ChainId.MOONBEAM], 6, 'USDC', 'USD Coin'), _USDC[ChainId.MOONBEAM_TESTNET] = /*#__PURE__*/new Token(ChainId.MOONBEAM_TESTNET, USDC_ADDRESS[ChainId.MOONBEAM_TESTNET], 6, 'USDC', 'USD Coin'), _USDC);
var WETH9 = (_WETH = {}, _WETH[ChainId.MOONBEAM] = /*#__PURE__*/new Token(ChainId.MOONBEAM, WETH9_ADDRESS[ChainId.MOONBEAM], 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.MOONBEAM_TESTNET] = /*#__PURE__*/new Token(ChainId.MOONBEAM_TESTNET, WETH9_ADDRESS[ChainId.MOONBEAM_TESTNET], 18, "WETH", "Wrapped Ether"), _WETH);
var WNATIVE = (_WNATIVE = {}, _WNATIVE[ChainId.MOONBEAM_TESTNET] = WETH9[ChainId.MOONBEAM_TESTNET], _WNATIVE[ChainId.MOONBEAM] = /*#__PURE__*/new Token(ChainId.MOONBEAM, WNATIVE_ADDRESS[ChainId.MOONBEAM], 18, 'WGLMR', 'Wrapped Glimmer'), _WNATIVE);
var SUSHI = (_SUSHI = {}, _SUSHI[ChainId.MOONBEAM] = /*#__PURE__*/new Token(ChainId.MOONBEAM, SUSHI_ADDRESS[ChainId.MOONBEAM], 18, 'EFT', 'Energyfi Token'), _SUSHI[ChainId.MOONBEAM_TESTNET] = /*#__PURE__*/new Token(ChainId.MOONBEAM_TESTNET, SUSHI_ADDRESS[ChainId.MOONBEAM_TESTNET], 18, 'EFT', 'EnergyFiToken'), _SUSHI);
...
var Moonbase = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Moonbase, _NativeCurrency);

  function Moonbase(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'DEV', 'Moonbase') || this;
  }

  Moonbase.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Moonbase(chainId);
  };

  var _proto = Moonbase.prototype;

  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };

  _createClass(Moonbase, [{
    key: "wrapped",
    get: function get() {
      var wnative = WNATIVE[this.chainId];
      !!!wnative ? process.env.NODE_ENV !== "production" ? invariant(false, 'WRAPPED') : invariant(false) : void 0;
...
var _NATIVE;
var NATIVE = (_NATIVE = {}, _NATIVE[ChainId.MOONBEAM_TESTNET] = /*#__PURE__*/Moonbase.onChain(ChainId.MOONBEAM_TESTNET), _NATIVE[ChainId.MOONBEAM] = /*#__PURE__*/Glmr.onChain(ChainId.MOONBEAM), _NATIVE);
...
export { AbstractCurrency, BAR_ADDRESS, BENTOBOX_ADDRESS, CHAIN_KEY, ChainId, ChainKey, CurrencyAmount, DAI_ADDRESS, FACTORY_ADDRESS, FIVE, Fraction, Glmr, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MAKER_ADDRESS, MAX_SAFE_INTEGER, MINICHEF_ADDRESS, MINIMUM_LIQUIDITY, MULTICALL2_ADDRESS, MaxUint256, Moonbase, NATIVE, NativeCurrency, ONE, Pair, Percent, Price, ROUTER_ADDRESS, Rounding, Route, Router, SOLIDITY_TYPE_MAXIMA, SUSHI, SUSHI_ADDRESS, SolidityType, TEN, THREE, TIMELOCK_ADDRESS, TWO, Token, Trade, TradeType, TradeVersion, USDC, USDC_ADDRESS, USDT_ADDRESS, USD_ADDRESS, WETH9, WETH9_ADDRESS, WNATIVE, WNATIVE_ADDRESS, ZERO, _100, _1000, _997, computePairAddress, computePriceImpact, currencyEquals, difference, getProviderOrSigner, getSigner, inputOutputComparator, maximum, minimum, rebase, sortedInsert, sqrt, toElastic, toHex, tradeComparator, validateAndParseAddress, validateSolidityTypeInstance };
