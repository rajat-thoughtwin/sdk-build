...
(function (ChainKey) {
  ...
  ChainKey["MOONBEAM_TESTNET"] = "moonbase";
...
var Dev = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Dev, _NativeCurrency);

  function Dev(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'DEV', 'Moonbase') || this;
  }

  Dev.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Dev(chainId);
  };

  var _proto = Dev.prototype;
